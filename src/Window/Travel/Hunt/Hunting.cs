...
{
    /// <summary>
    ///     Used to allow the players party to sweep the food tables for grabbable trays, snagging a tray before another
    ///     shopper does will successfully bag it and when the round is over the amount of food is determined by what trays
    ///     were grabbed. The player party can only haul back up to one hundred pounds of whatever the value was back to the
    ///     SUV regardless of what it was.
    /// </summary>
