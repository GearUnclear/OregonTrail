...
namespace OregonTrailDotNet.Window.Travel.RiverCrossing
{
    ...
    public enum RiverCrossChoice
    {
        ...
        /// </summary>
        [Description("GUN IT THROUGH THE HIGH WATER")] Ford = 1,
        ...
        /// </summary>
        [Description("SEAL THE DOORS, TAKE THE WASHED-OUT SHOULDER DETOUR")] Float = 2,
        ...
        /// </summary>
        [Description("PAY FOR THE NATIONAL GUARD HIGH-WATER CONVOY")] Ferry = 3,
        ...
        /// </summary>
        [Description("HIRE A SOVEREIGN-CITIZEN LOCAL")] Indian = 4,

        /// <summary>
        ///     Waits for a day still ticking events but waiting to see if the floodwater recedes and FEMA reopens the road.
        /// </summary>
        [Description("WAIT FOR THE WATER TO RECEDE / FEMA TO REOPEN")] WaitForWeather = 5,
