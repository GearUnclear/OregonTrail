...
namespace OregonTrailDotNet.Window.Travel.RiverCrossing
{
    ...
    public sealed class CrossingTick : Form<TravelInfo>
    {
        ...
        public override void OnFormPostCreate()
        {
            ...
            // Check if the Indian guide wants his clothes for the trip that you agreed to. Use >= to match the
            // offer gate in IndianGuidePrompt (Clothes >= IndianCost); a strict > let a party with exactly the
            // cost cross free.
