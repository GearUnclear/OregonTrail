...
namespace OregonTrailDotNet.Module.Time
{
    ...
    public sealed class TimeModule : WolfCurses.Module.Module
    {
        ...
        public void TickTime(bool skipDay)
        {
            ...
            {
                // Advancing from the last day of the month to the first of the next is still one full day elapsing,
                // so it must be counted here too - omitting it made TotalDays undercount by one for every month
                // boundary.
                TotalDaysThisYear++;
                TotalDays++;
